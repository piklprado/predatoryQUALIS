...
* Lista final de periódicos potencialmente predatórios que usei 
...
A proporção de títulos potencialmente predatórios por área varia em uma ordem de grandeza, 
...
kable(tmp[order(tmp$ppred),c("area","tot","tot.pred","ppred")],
      ...
      caption="Número de periódicos e de potencialmente predatórios, por área de avaliação. As área estão em ordem crescente da proporção de potenciais predatórios")
```
...
nos estratos A e B por pelo menos uma área. Periódicos potenciais predatórios estão presentes em todos os estratos, 
...
de títulos potencialmente predatórios nos quais a comundidade publica chegue a 5%. Por outro lado, seria preciso avaliar a proporçãod a produção está nestes periódicos. Mais importante, apesar de baixa a proporção mostra que na maioria das áreas há pessoas que publicaram nestes veículos.
* Se a proporção de potenciais predatórios em relação ao total de títulos não é alarmante, a proporção que não é classificada no estrato C impressiona - a mediana deste proporção entre as áreas é `r round(median(tmp$C/tmp$tot.pred),3)`. Ou seja, na maioria da áreas mais da metade do títulos potencialmente predatórios não são descartados da avaliação.
* Outro ponto importante é a grande heterogeneidade das áreas quanto a esta "detecção de predatórios". Apesar disso, não há uma tendência clara entre agrupamentos dessa áreas, como grandes áreas, colégios ou áreas mais aplicadas e bássicas. Isso acontece que porque em quase todos estes grupos há pelo menos uma área que foge ao padrão. Por exemplo, nas Agrárias, que têm em geral detecção baixa, Alimentos mostra valores altos. Já entre as Engenharias que têm valores mais altos, a Engenharia II é discrepante. 
